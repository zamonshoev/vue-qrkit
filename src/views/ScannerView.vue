        ...
        <div v-else class="flex flex-1 flex-col gap-3">
          <div class="rounded-2xl border border-gray-300 bg-white p-6 shadow-xl">
            ...
            <div v-if="result.startsWith('http')" class="mt-4 border-t border-gray-100 pt-4">
              :href="result" target="_blank" rel="noopener noreferrer" class="inline-flex
              items-center gap-1.5 rounded-lg border border-gray-300 px-4 py-2 text-xs text-gray-700
              transition hover:border-gray-800 hover:text-gray-900" > Open link
              <svg
                xmlns="http://www.w3.org/2000/svg"
                class="h-3 w-3"
                fill="none"
